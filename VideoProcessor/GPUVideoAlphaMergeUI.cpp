...
const string TEXT_VIDEO_RGB = "Video Source RGB";
const string TEXT_VIDEO_ALPHA = "Video Source Alpha";

const string TEXT_VIDEO_OUT = "Video Source Output";
...
void GPUVideoAlphaMergeFrame::OnGPUVideoAlphaMergeFrameButtonOk(wxCommandEvent& event) {
    ...
    gpu_video_alpha_merge_init(vam, stoi(str.c_str().AsChar()));
