...
class BasicDrawPane : public wxPanel {
    enum MenuIDs { MENU_ID_SHARED_MEMORY_BUFFER = wxID_HIGHEST + 1, MENU_ID_VIDEO_SOURCE, MENU_ID_IM_SHOW, MENU_ID_MASK_RCNN, MENU_ID_GPU_VIDEO_ALPHA_MERGE, MENU_ID_GPU_MEMORY_BUFFER, MENU_ID_GPU_DENOISE, MENU_ID_GPU_COMPOSER, MENU_ID_GPU_COMPOSER_ELEMENT, MENU_ID_GPU_MOTION_BLUR, MENU_ID_GPU_GAUSSIAN_BLUR, MENU_ID_GPU_EDGE_FILTER, MENU_ID_GPU_PALETTE_FILTER, MENU_ID_GPU_AUDIOVISUAL, MENU_ID_AUDIO_SOURCE, MENU_ID_MINI_GINE, MENU_ID_GPU_GREEN_SCREEN, MENU_ID_CAMERA_CONTROL, MENU_ID_CAMERA_CONTROL_DIAGNOSTIC, MENU_ID_STATISTICS_3D, MENU_ID_DETECTION_SIMULATION_3D, MENU_ID_EDIT_NODE, MENU_ID_EDIT_NODE_SETTINGS, MENU_ID_DELETE_NODE, MENU_ID_START_NODE };
