...
void BasicDrawPane::OnShowContextMenu(wxMouseEvent& event) {
    ...
    if (application_graph_hovering_node_id > -1) {
        ...
        menu->Append(MENU_ID_GPU_GREEN_SCREEN, wxT("GPU Green Screen"));
        ...
        menu->Append(MENU_ID_STATISTICS_3D, wxT("Statistics 3D"));
        menu->Append(MENU_ID_DETECTION_SIMULATION_3D, wxT("Detection Simulation 3D"));
    }
    PopupMenu(menu);
}
...
void BasicDrawPane::OnContextMenuSelected(wxCommandEvent& event) {
    ...
    case MENU_ID_GPU_AUDIOVISUAL:
        ...
        break;
    case MENU_ID_GPU_GREEN_SCREEN:
        ui_manager_show_frame(AGCT_GPU_GREEN_SCREEN, application_graph_active_id);
        break;
    ...
    case MENU_ID_CAMERA_CONTROL_DIAGNOSTIC:
        ...
        break;
    case MENU_ID_STATISTICS_3D:
        ui_manager_show_frame(AGCT_STATISTICS_3D, application_graph_active_id);
        break;
    case MENU_ID_DETECTION_SIMULATION_3D:
        ui_manager_show_frame(AGCT_DETECTION_SIMULATION_3D, application_graph_active_id);
        break;
    ...
    case MENU_ID_EDIT_NODE: {
            ...
            switch (agn->component_type) {
                ...
                case AGCT_GPU_GREEN_SCREEN: {
                    ui_manager_show_frame(AGCT_GPU_GREEN_SCREEN, application_graph_active_id, application_graph_hovering_node_id);
                    break;
                }
                ...
                case MENU_ID_STATISTICS_3D: {
                    ui_manager_show_frame(AGCT_STATISTICS_3D, application_graph_active_id, application_graph_hovering_node_id);
                    break;
                }
                case MENU_ID_DETECTION_SIMULATION_3D: {
                    ui_manager_show_frame(AGCT_DETECTION_SIMULATION_3D, application_graph_active_id, application_graph_hovering_node_id);
                    break;
                }
            }
        }
